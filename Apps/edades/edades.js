...
function SolicitarEdades(){
    let decoradorTitulo = ("=".repeat(50))
    console.log(decoradorTitulo)
    console.log("BIENVENIDO AL PROGRAMA DE ESTADISTICA DE EDADES")
    console.log(decoradorTitulo)
    for (let i = 0; i < NUM_EDADES; i++) {
        ...
        do {
            ...
            if (isNaN(edad) || edad < 1 || edad > 120) {
                console.log("La edad ingresada no es válida. Por favor, ingrese una edad entre 1 y 120.");
            }
        } while (isNaN(edad) || edad < 1 || edad > 120); // Repite si la entrada no es válida
        edades.push(edad); // Agrega la edad válida al array
    }
    let decorador = ("=".repeat(65))
...
function MostrarResultados(){
    console.log(decorador)
    console.log("ESTADISTICA DE EDADES INGRESADAS")
    console.log(decorador)
